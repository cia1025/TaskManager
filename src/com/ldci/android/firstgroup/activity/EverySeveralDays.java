...
public class EverySeveralDays extends Activity {

	private EditText etYear,etMonth,etDay, etSeveralDay;
	private GridView  gv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.everyseveraldays);
		
		//匹配XML文件控件
		etYear= (EditText) findViewById(R.id.etYear);
		etMonth =(EditText) findViewById(R.id.etMonthr);
		etDay =(EditText) findViewById(R.id.etDay);
		etSeveralDay =(EditText) findViewById(R.id.etEverySeveralDays);
		...
		//将控件内容设置为传入的间隔天数
		if (loop.equals("2"))// 只有当循环类型为指定天数循环时才需要转换循环参数
		{
			etSeveralDay.setText(loopinfo);
		}
		else
		{
			etSeveralDay.setText("1");
		}
        ...
        gv.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				case 2://确定
					...
					loopinfo = etSeveralDay.getText().toString();
